...
public class Parentheses {
    ...
    private final static Logger LOGGER = LoggerFactory.getLogger(Parentheses.class);
    ...
    public static void main(String[] args) {
        ...
        String b = "[()]{}{[()()]()}";
        LOGGER.info(b + " is balanced: " + isBalanced(b));

        LOGGER.info("===============");

        String nb = "[)]{]}";
        LOGGER.info(nb + " is balanced: " + isBalanced(nb));
    }
